...
```powershell
Uninstall-ADTWinGetPackage [[-Query] <String>] [-MatchOption <String>] [-Force] [-Id <String>] [-Log <String>]
 [-Mode <String>] [-Moniker <String>] [-Name <String>] [-Scope <String>] [-Source <String>] [-Version <String>]
