...
function Get-ADTWinGetPackage
{
    ...
    process
    {
        ...
        catch
        {
            ...
            Invoke-ADTFunctionErrorHandler -Cmdlet $PSCmdlet -SessionState $ExecutionContext.SessionState -ErrorRecord $_ -LogMessage "Failed to get the specified WinGet package."
        }
    }
