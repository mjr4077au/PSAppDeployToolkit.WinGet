...
function Install-ADTWinGetPackage
{
    ...
    .PARAMETER UninstallPrevious
        Uninstall any previous version of the package before installing.
    ...
    .EXAMPLE
        Install-ADTWinGetPackage -Id Microsoft.PowerShell -UninstallPrevious

        This example shows how to install a package while uninstalling any previous version first.
    ...
    process
    {
        ...
        catch
        {
            ...
            Invoke-ADTFunctionErrorHandler -Cmdlet $PSCmdlet -SessionState $ExecutionContext.SessionState -ErrorRecord $_ -LogMessage "Failed to install the specified WinGet package." -DisableErrorResolving:($null -ne $wingetResult)
        }
