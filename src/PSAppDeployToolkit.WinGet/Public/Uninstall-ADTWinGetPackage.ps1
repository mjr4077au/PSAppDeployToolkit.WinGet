    ...
    process
    {
        ...
        try
        {
            try
            {
                ...
                $wingetResult = Invoke-ADTWinGetDeploymentOperation -Action Uninstall @PSBoundParameters
            }
            catch
            {
        ...
        catch
        {
            ...
            Invoke-ADTFunctionErrorHandler -Cmdlet $PSCmdlet -SessionState $ExecutionContext.SessionState -ErrorRecord $_ -LogMessage "Failed to uninstall the specified WinGet package." -DisableErrorResolving:($null -ne $wingetResult)
        }
